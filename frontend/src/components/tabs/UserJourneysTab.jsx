...
import JourneyDetails, {contactStatusOptions} from "../journeys/JourneyDetails";
        ...
        <Routes>
            <Route path={"/"} element={
                <div style={{display: "flex", overflow: "hidden", flexDirection: "column", paddingBottom: 30}}>
                    ...
                    {!loading &&
                        <JourneyList journeys={journeys} search={search} clearSort={clearSort}
...
export default UserJourneysTab;